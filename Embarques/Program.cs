...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        Title = "Embarques API",
        Version = "v1",
        Description = "API para gestión de embarques con autenticación JWT",
    ...
    {
        Name = "Authorization",
        Description = "Ingresa el JWT token con el esquema Bearer: Bearer {token}",
